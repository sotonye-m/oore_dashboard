    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!err?.response) {
                ...
                toast.error(err.response?.data?.errors?.message || 'Invalid email or password');
            } else {
            ...
            <Main>
                <LoginForm onSubmit={handleSubmit}>
                    ...
                    <div style={{ marginBottom: '10px' }}>
                        <a style={{ color: '#00A667', fontFamily: 'Montserrat', fontSize: '12px', fontWeight: '600', lineHeight: '14.63px', textAlign: 'center', margin: '10px', textDecoration: 'none' }} href="/forgot-password">Forgot password?</a>
                    </div>
                    <PrimaryButton type='submit'>Login</PrimaryButton>
                    <div style={{ margin: '10px' }}>
                        Don't have an account? <a style={{ color: '#00A667', textDecoration: 'none' }} href="/signup">Sign up</a>
                    </div>
                </LoginForm>
            </Main>
            <MainDiv>
